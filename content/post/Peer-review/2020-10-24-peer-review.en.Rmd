...
I think the only suggestion or improvement that I would recommend would be changing the slider input in the first tab to a slider range. This would allow users to see countries with cases between a set of values, rather than just being able to see countries with cases below a certain value. 

#### The Documentation

The documentation in the README file is very detailed and provides a great overview of the package and the application. 

Additionally, the functions have been well documented, however, my recommendation would be to provide additional information on what the functions return. 
...
- <input type="checkbox" checked> </input> **Installation instructions:** for the package is found in README
